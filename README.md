...
:warning:First of all you need to modify some  in the [`scapp.yml`](src/scapp.yml) press ``[ctrl+H]`` then replace all cloud-romtourpe.westeurope.cloudapp.azure.com by your VM ip address :warning:
